export const homePageContent = {
  hero: {
    ...
    stats: [
      ...
      { iconName: 'Book', text: '500+ Studies' },
      { iconName: 'ChatBubble', text: '10k+ Interactions' }
    ]
  },
  whyChooseTTO: {
    ...
    features: [
      ...
      //   description: 'This new feature does incredible things for researchers everywhere.'
      // }
    ]
  },
  makingImpact: {
    title: "Making an Impact",
    subtitle: "Join thousands of researchers and knowledge seekers worldwide",
    stats: [
      { value: "1K+", label: "Active Researchers" },
      { value: "500+", label: "Published Studies" },
      { value: "10K+", label: "AI Interactions" },
      { value: "50+", label: "Research Fields" }
    ]
  },
  howItWorks: {
    title: "How It Works",
