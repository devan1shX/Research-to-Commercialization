...
const StudyDetailPage = () => {
    ...
    const filteredAndSortedQuestions = study.questions
        ? questionsToShow.map(q_text => study.questions.find(q => q.question === q_text)).filter(Boolean)
        : [];
        ...
        >
            ...
            >
                ...
                {filteredAndSortedQuestions.length > 0 && (
                    <RelatedQuestions questions={filteredAndSortedQuestions} />
                )}
            </Container>
        </Box>
    );
